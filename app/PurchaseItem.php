...
class PurchaseItem extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['warehouses_id', 'products_id', 'purchase_invoices_id', 'business_id', 'users_id', 'name', 'sku', 'batch_no', 'expire_date', 'quantity', 'amount', 'unit', 'discount_type', 'discount_amount', 'vat_amount', 'deleted_at', 'created_at', 'updated_at'];
