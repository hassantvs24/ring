 ...
 */
class VatTaxTransaction extends Model
{
   // use SoftDeletes;
    /**
     ...
     * @var array
     */
    protected $fillable = ['warehouses_id', 'account_books_id', 'business_id', 'users_id', 'code', 'amount', 'payment_method', 'card_number', 'card_holder_name', 'card_transaction_no', 'card_type', 'card_month', 'card_year', 'csv', 'cheque_number', 'bank_account_no', 'transaction_no', 'description', 'deleted_at', 'created_at', 'updated_at'];
    ...
    {
        return $this->hasMany('App\AllTransaction', 'vat_tax_transactions_id');
    }
