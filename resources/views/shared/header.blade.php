                    ...
                    <ul class="media-list dropdown-content-body">
                        <li class="media">
                            <div class="media-left">
                                <img src="{{asset('public/global_assets/images/placeholders/placeholder.jpg')}}" class="img-circle img-sm" alt="Message">
                        ...
                        <li class="media">
                            <div class="media-left"> <img src="{{asset('public/global_assets/images/placeholders/placeholder.jpg')}}" class="img-circle img-sm" alt="Message"></div>
                            <div class="media-body">
                                <a href="#" class="media-heading">
