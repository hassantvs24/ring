            ...
            @foreach($table as $row)
                <tr>
                    ...
                    <td class="text-right p-td">
                        <x-actions>
                        <!--<li><a href="{{route('supplier.edit-payment', ['id' => $row->id, 'supplier' => $supplier->id])}}"
                            ...
                            <li><a href="{{route('supplier.del-payment', ['id' => $row->id])}}" class="delItem"><i class="icon-bin text-danger"></i> Delete</a></li>
                        </x-actions>
                    </td>
                </tr>
            @endforeach
